...
import (
	...
	v1alpha1 "opensergo.io/api/client/pkg/clientset/versioned/typed/policy/v1alpha1"
)
...
func (c *FakePolicyV1alpha1) CircuitBreakers(namespace string) v1alpha1.CircuitBreakerInterface {
