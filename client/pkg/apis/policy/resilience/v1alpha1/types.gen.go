...
import (
	...
	resiliencev1alpha1 "opensergo.io/api/policy/resilience/v1alpha1"
)
...
type CircuitBreaker struct {
	...
	// +optional
	Spec resiliencev1alpha1.CircuitBreaker `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
