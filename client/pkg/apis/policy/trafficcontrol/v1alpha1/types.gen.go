...
import (
	...
	trafficcontrolv1alpha1 "opensergo.io/api/policy/trafficcontrol/v1alpha1"
)
...
type ConcurrencyLimiting struct {
	...
	// +optional
	Spec trafficcontrolv1alpha1.ConcurrencyLimiting `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
...
type RateLimiting struct {
	...
	// Spec defines the implementation of this definition.
	// +optional
	Spec trafficcontrolv1alpha1.RateLimiting `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec"`
