	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PolicyV1alpha1().CircuitBreakers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PolicyV1alpha1().CircuitBreakers(namespace).Watch(context.TODO(), options)
			},
		},
		&policyv1alpha1.CircuitBreaker{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *circuitBreakerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&policyv1alpha1.CircuitBreaker{}, f.defaultInformer)
}
