...
import (
	...
	resiliencev1alpha1 "opensergo.io/api/client/pkg/apis/policy/resilience/v1alpha1"
	...
	v1alpha1 "opensergo.io/api/client/pkg/listers/resilience/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ResilienceV1alpha1().CircuitBreakers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ResilienceV1alpha1().CircuitBreakers(namespace).Watch(context.TODO(), options)
			},
		},
		&resiliencev1alpha1.CircuitBreaker{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *circuitBreakerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&resiliencev1alpha1.CircuitBreaker{}, f.defaultInformer)
}
