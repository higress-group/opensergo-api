	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TrafficcontrolV1alpha1().ConcurrencyLimitings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TrafficcontrolV1alpha1().ConcurrencyLimitings(namespace).Watch(context.TODO(), options)
			},
		},
		&trafficcontrolv1alpha1.ConcurrencyLimiting{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *concurrencyLimitingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&trafficcontrolv1alpha1.ConcurrencyLimiting{}, f.defaultInformer)
}
